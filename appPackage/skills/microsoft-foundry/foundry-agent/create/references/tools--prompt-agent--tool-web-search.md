...
> ⚠️ **Warning:** For Bing Grounding or Bing Custom Search (which require a separate Bing resource and project connection), see [tool-bing-grounding.md](./tools--prompt-agent--tool-bing-grounding.md). Only use those when explicitly requested.
