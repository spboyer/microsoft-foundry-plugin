...
> Use this path only when the user explicitly asks for programmatic/CLI/CI/CD creation. Otherwise, guide them to the [portal](./guardrails--guardrail-manage.md#default-path-portal).
...
After creating a guardrail, assign it to a hosted agent, model deployment, or toolbox → [guardrail-attach.md](./guardrails--guardrail-attach.md)
