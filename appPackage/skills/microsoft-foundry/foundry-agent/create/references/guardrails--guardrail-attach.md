...
After creating a guardrail (via [portal](./guardrails--guardrail-manage.md) or [REST API](./guardrails--guardrail-api-create.md)), attach it to one of three targets:
...
> `rai_policy_name` must match a guardrail that exists on the AI Services account. Use `Microsoft.Default`, `Microsoft.DefaultV2`, or a custom name created via [portal or API](./guardrails--guardrail-api-create.md).
...
- [Guardrails overview](./guardrails--guardrail-manage.md) — create guardrails, default policies, intervention points
- [API create](./guardrails--guardrail-api-create.md) — create guardrails via REST API
