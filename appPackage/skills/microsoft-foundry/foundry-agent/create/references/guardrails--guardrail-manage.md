...
- Attach a guardrail to a hosted agent, model deployment, or toolbox → [guardrail-attach.md](./guardrails--guardrail-attach.md)
- Create a guardrail via REST API → [guardrail-api-create.md](./guardrails--guardrail-api-create.md)
...
> Use the API path ([guardrail-api-create.md](./guardrails--guardrail-api-create.md)) only when the user explicitly asks for programmatic/CLI/CI/CD creation.
