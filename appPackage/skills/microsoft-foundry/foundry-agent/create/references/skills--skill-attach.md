...
**Prerequisites:**
- Skills provisioned in the Foundry project — see [skill-manage.md](./skills--skill-manage.md)
...
**Prerequisites:**
- Skills provisioned in the Foundry project — see [skill-manage.md](./skills--skill-manage.md)
- Skills attached to a toolbox — see [skill-toolbox-attach.md](./skills--skill-toolbox-attach.md)
...
- [skill-manage.md](./skills--skill-manage.md) — create, version, and manage skills
