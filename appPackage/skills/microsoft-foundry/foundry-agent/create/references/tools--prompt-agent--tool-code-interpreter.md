...
`CodeInterpreterTool` — see [tool-mcp.md](./tools--prompt-agent--tool-mcp.md) for the general prompt-agent tool-wiring pattern; Code Interpreter takes no constructor arguments.
