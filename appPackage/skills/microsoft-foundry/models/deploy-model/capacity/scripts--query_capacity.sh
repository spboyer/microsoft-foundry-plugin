...
#
# Usage:
#   ./scripts--query_capacity.sh <model-name> [model-version] [region] [sku]
# Examples:
#   ./scripts--query_capacity.sh o3-mini                          # List versions
#   ./scripts--query_capacity.sh o3-mini 2025-01-31               # All regions
#   ./scripts--query_capacity.sh o3-mini 2025-01-31 eastus2       # Specific region
#   ./scripts--query_capacity.sh o3-mini 2025-01-31 "" Standard   # Different SKU
