...
**After discovery → hand off to [preset](../preset/preset-skill.md) or [customize](../customize/customize-skill.md) for actual deployment.**
...
1. 🚀 **Quick deploy** to top recommendation with defaults → route to [preset](../preset/preset-skill.md)
2. ⚙️ **Custom deploy** with version/SKU/capacity/RAI selection → route to [customize](../customize/customize-skill.md)
3. 📊 **Check another model** or capacity target → re-run Phase 2
4. ❌ Cancel

### Phase 5: Confirm Project Before Deploying

Before handing off to preset or customize, **always confirm the target project** with the user. See the [Project Selection](../deploy-model-skill.md#project-selection-all-modes) rules in the parent router.
...
- **[preset](../preset/preset-skill.md)** — Quick deployment after capacity discovery
- **[customize](../customize/customize-skill.md)** — Custom deployment after capacity discovery
