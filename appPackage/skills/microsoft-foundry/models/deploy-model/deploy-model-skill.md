...
|------|-------------|-----------|
| **Preset** | Quick deployment, no customization needed | [preset/preset-skill.md](preset/preset-skill.md) |
| **Customize** | Full control: version, SKU, capacity, RAI policy | [customize/customize-skill.md](customize/customize-skill.md) |
| **Capacity Discovery** | Find where you can deploy with specific capacity | [capacity/capacity-skill.md](capacity/capacity-skill.md) |
...
- **[preset/preset-skill.md](preset/preset-skill.md)** — Quick deployment to optimal region with sensible defaults
- **[customize/customize-skill.md](customize/customize-skill.md)** — Interactive guided flow with full configuration control
- **[capacity/capacity-skill.md](capacity/capacity-skill.md)** — Discover available capacity across regions and projects
